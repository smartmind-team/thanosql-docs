...
③ 이름 : 테이블 이름을 작성할 수 있습니다. 테이블 이름은 문자, 숫자, 언더스코어를 포함 할 수 있으며 숫자로 시작할 수 없습니다.


__컬럼 설정__

④ Name(이름) : 해당 컬럼 이름을 작성할 수 있습니다. (필수값 입니다.)

⑤ Data Type(데이터 타입) : 해당 컬럼의 데이터 타입을 선택 할 수 있습니다. (필수값 입니다.)
