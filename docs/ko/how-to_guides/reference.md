...
- [__UPLOAD MODEL__](/ko/how-to_guides/ThanoSQL_query/UPLOAD_SYNTAX/) — 사용자가 직접 만든 모델 ThanoSQL workspace DB에 올리기
...
- [__GET__](/ko/how-to_guides/ThanoSQL_query/GET_SYNTAX/) —  ThanoSQL workspace DB에 저장되어 있는 모델, 데이터 테이블 가져오기
- [__LIST__](/ko/how-to_guides/ThanoSQL_query/LIST_SYNTAX/) — ThanoSQL workspace DB에 저장되어 있는 모델, 데이터 테이블, 튜토리얼 목록 조회
- [__COPY__](/ko/how-to_guides/ThanoSQL_query/COPY_SYNTAX/) - 워크스페이스에 있는 데이터 파일들로 ThanoSQL workspace DB 안의 데이터 테이블 생성
...
- [__ThanoSQL workspace DB 업로드__](/ko/how-to_guides/ThanoSQL_connecting/rest_api_thanosql_insert/)
